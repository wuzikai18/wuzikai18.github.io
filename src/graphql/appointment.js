...
var requestOptions = {
 ...
 const result = await response.json();
  ...
  result.list = result.data.appointment;
 return result;
}
...
export async function updateAdvise(id, objects) {
  ...
  var graphql = JSON.stringify({
    query: "mutation ($id: bigint!,$objects:appointment_set_input) {\r\n  update_appointment(_set: $objects , where: {id: {_eq: $id}}) {\r\n    affected_rows\r\n  }\r\n}",
