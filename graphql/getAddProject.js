...
export async function createProduct(objects) {
    ...
    var graphql = JSON.stringify({
        query: "mutation ($objects: [add_project_insert_input!]!) {\n  insert_add_project(objects: $objects) {\r\n    affected_rows\r\n    returning{\r\n      id\r\n    }\n}\n}\n",
...
export async function updateProduct(id, objects) {
    ...
    var graphql = JSON.stringify({
        query: "mutation ($id: bigint!,$objects:add_project_set_input) {\r\n  update_add_project(_set: $objects , where: {id: {_eq: $id}}) {\r\n    affected_rows\r\n  }\r\n}",
