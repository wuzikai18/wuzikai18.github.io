...
<div class="flex items-center justify-between mb-4">
    <div class="flex justify-around">
        <el-button class="mr-4" v-if="btns.includes('create')" type="primary" size="small" @click="$emit('create')">新增</el-button>
        
        <el-popconfirm class="mr-4" v-if="btns.includes('delete')" title="是否要删除选中记录？" confirmButtonText="确认" cancelButtonText="取消" @confirm="$emit('delete')">
            <template #reference>
